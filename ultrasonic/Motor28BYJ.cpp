...
Motor28BYJ::Motor28BYJ(uint8_t pin1, uint8_t pin2, uint8_t pin3, uint8_t pin4, uint8_t pin1a, uint8_t pin2a, uint8_t pin3a, uint8_t pin4a) {
  _pins[0] = pin1;
  _pins[1] = pin2;
  _pins[2] = pin3;
  _pins[3] = pin4;
...
void Motor28BYJ::step(int duration, int8_t directionA, int8_t directionB) {
